...
<head>
    <meta charset="UTF-8" />
    <title>Branding - The Design Spark</title>
     ...
     <li><a href="{{route('graphicdesign')}}">Graphic Design</a></li>
        ...
        <section class="breadcrumb-area breadcrumb-area3 abbn">
            <div class="container video_container">
                <video src="./images/newimg/Branding.mp4" autoplay muted loop class="video"></video>
                <div class="row">
                    <div class="col-xl-12">
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center" class="pppd">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal1">
                            <img src="images/newimg/b1.jpg" class="imgcvr" />
                        </a>
                        <div id="modal1" class="modal mlimg">
                            <img src="images/newimg/b1.jpg" alt="" class="mlimg1" />
                        </div>
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal2">
                            <img src="images/newimg/minas.jpg" class="imgcvr" />
                        </a>
                        <div id="modal2" class="modal mlimg">
                            <img src="images/newimg/minas.jpg" alt="" class="mlimg1" />
                        </div>
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal3">
                            <img src="images/newimg/b3.jpg" class="imgcvr" />
                        </a>
                        <div id="modal3" class="modal mlimg">
                            <img src="images/newimg/b3.jpg" alt="" class="mlimg1" />
                        </div>
        ...
        <div class="container-fluid txtbn text-center">
            <div class="row">
                <div class="col-md-12 d-flex align-items-center onhv pad y cta_uper">
                    <div>
                        <h2 class="padbn">
                            Build a Strong Identity with Expert Branding Services
                        </h2>
                        <p class="padbn">
                            Is your brand making the impact it deserves? Our branding
                            services are designed to help you establish a powerful identity
                            that resonates with your target audience. We focus on creating
                            unique logos, cohesive visual elements, and compelling brand
                            narratives that reflect your values and mission. Our team
                            collaborates with you to develop a comprehensive branding
                            strategy that not only enhances recognition but also builds
                            trust and loyalty. Let us help you elevate your brand and create
        ...
        <div class="container-fluid pb quote quote_branding">
