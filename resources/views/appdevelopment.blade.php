...
<head>
    <meta charset="UTF-8" />
    <title>Mobile App Development - The Design Spark</title>
     ...
     <li><a href="{{route('graphicdesign')}}">Graphic Design</a></li>
      ...
      >
        ...
        <section class="breadcrumb-area breadcrumb-area3 abbn">
            <div class="container">
                <video src="./images/newimg/mobile app.mp4" autoplay muted loop class="video"></video>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="inner-content text-center clearfix">
                            <div class="big-title" style="color: transparent">
        ...
        <div class="container-fluid txtbn text-center">
            <div class="row">
                <div class="col-md-12 d-flex align-items-center onhv pad y cta_uper">
                    <div>
                        <h2 class="padbn">
                            Unlock Your Business Potential with Our Mobile App Development Services
                        </h2>
                        <p class="padbn">
                            In the fast-paced digital era, having a sleek, high-functioning mobile app is no longer a luxury—it’s a necessity. Your customers are glued to their phones, so why not be right there in their pockets, one tap away? Whether you’re a startup with big ideas or an established business looking to innovate, our mobile app development services are here to make you the next “must-download” app.
                        </p>
                    </div>
                </div>
            </div>
