...
<head>
    <meta charset="UTF-8" />
    <title>Logo Design - The Design Spark</title>
     ...
     <li><a href="{{route('graphicdesign')}}">Graphic Design</a></li>
      ...
      >
        ...
        <section class="breadcrumb-area breadcrumb-area3 abbn">
            <div class="container">
                <video src="./images/newimg/logo design.mp4" autoplay muted loop class="video"></video>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="inner-content text-center clearfix">
                            <div class="big-title" style="color: transparent">
            ...
            <div class="row">
                <div class="col-md-12 d-flex align-items-center onhv pad y cta_uper">
                    <div>
                        ...
                        <p class="padbn">
                          Our graphic design team creates eye-catching visuals that capture your brand's
                          essence and communicate your message effectively. From logos and branding to marketing
                          materials and social media graphics, our team can help elevate your brand and make it stand
                          out from the competition. We pride ourselves on delivering high-quality designs that exceed
