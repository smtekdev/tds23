...
<head>
    <meta charset="UTF-8" />
    <title>E-CommSparkerce - The Design </title>
     ...
     <li><a href="{{route('graphicdesign')}}">Graphic Design</a></li>
        ...
        <section class="breadcrumb-area breadcrumb-area3 abbn">
            <div class="container video_container">
                <video src="./images/newimg/Ecommerce Website.mp4" autoplay muted loop class="video"></video>
                <div class="row">
                    <div class="col-xl-12">
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center" class="pppd">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal1">
                            <img src="images/newimg/ecw1.png" class="imgcvr" />
                        </a>
                        <div id="modal1" class="modal mlimg">
                            <img src="images/newimg/ecw1.png" alt="" class="mlimg1" />
                        </div>
                ...
                <div class="col-md-4 brrd rainbow2">
                    <div class="text-center">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal2">
                            <img src="images/newimg/ecw2.png" class="imgcvr" />
                        </a>
                        <div id="modal2" class="modal mlimg">
                            <img src="images/newimg/ecw2.png" alt="" class="mlimg1" />
                        </div>
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal3">
                            <img src="images/newimg/ecw3.png" class="imgcvr" />
                        </a>
                        <div id="modal3" class="modal mlimg">
                            <img src="images/newimg/ecw3.png" alt="" class="mlimg1" />
                        </div>
        ...
        <div class="container-fluid txtbn text-center">
            <div class="row">
                <div class="col-md-12 d-flex align-items-center onhv pad y cta_uper_ecommmerce">
                    <div>
                        <h2 class="padbn">
                            Build Your Brand with a Professional E-Commerce Website
                        </h2>
                        <p class="padbn">
                            Looking to launch or enhance your online store? Our team
                            specializes in creating robust e-commerce websites that deliver
                            an exceptional shopping experience. We design user-friendly
                            interfaces, secure payment gateways, and mobile-responsive
                            layouts to ensure your customers can shop effortlessly from any
                            device. With a focus on conversion optimization and seamless
                            functionality, we help you turn visitors into loyal customers.
                            Let us empower your business with a powerful e-commerce platform
        ...
        <div class="container-fluid pb quote quote_ecommerce">
