...
<head>
    <meta charset="UTF-8" />
    <title>Illustration - The Design Spark</title>
     ...
     <li><a href="{{route('graphicdesign')}}">Graphic Design</a></li>
        ...
        <section class="breadcrumb-area breadcrumb-area3 abbn">
            <div class=" container video_container">
                <video src=" ./images/newimg/Illustrations.mp4" autoplay muted loop class="video"></video>
                <div class="row">
                    <div class="col-xl-12">
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center" class="pppd">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal1">
                            <img src="images/newimg/il1 (1).jpg" class="imgcvr" />
                        </a>
                        <div id="modal1" class="modal mlimg">
                            <img src="images/newimg/il1 (1).jpg" alt="" class="mlimg1" />
                        </div>
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal2">
                            <img src="images/newimg/il2.jpg" class="imgcvr" />
                        </a>
                        <div id="modal2" class="modal mlimg">
                            <img src="images/newimg/il2.jpg" alt="" class="mlimg1" />
                        </div>
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal3">
                            <img src="images/newimg/il3.jpg" class="imgcvr" />
                        </a>
                        <div id="modal3" class="modal mlimg">
                            <img src="images/newimg/il3.jpg" alt="" class="mlimg1" />
                        </div>
        ...
        <div class="container-fluid txtbn text-center">
            <div class="row">
                <div class="col-md-12 d-flex align-items-center onhv pad y cta_uper">
                    <div>
                        <h2 class="padbn">
                            Bring Your Concepts to Life with Unique Illustrations
                        </h2>
                        <p class="padbn">
                            Do you need illustrations that capture the essence of your brand
                            and engage your audience? Our skilled illustrators create custom
                            artwork tailored to your vision, whether it�s for marketing
                            materials, product designs, or storytelling. We blend creativity
                            and strategy to produce illustrations that not only look
                            stunning but also convey your message effectively. Let us
                            transform your ideas into captivating visuals that resonate with
