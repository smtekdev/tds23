...
<head>
    <meta charset="UTF-8" />
    <title>Website Development - The Design Spark</title>
     ...
     <li><a href="{{route('graphicdesign')}}">Graphic Design</a></li>
      ...
      >
        ...
        <section class="breadcrumb-area breadcrumb-area3 abbn">
            <div class="container">
                <video src="./images/newimg/wd.mp4" autoplay muted loop class="video"></video>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="inner-content text-center clearfix">
                            <div class="big-title" style="color: transparent">
            ...
            <div class="row">
                <div class="col-md-12 d-flex align-items-center onhv pad y cta_uper">
                    <div>
                        ...
                        <p class="padbn">
                          Our web development team specializes in creating innovative and custom web
                          solutions that help businesses of all sizes achieve their online goals. From website design
                          and development to e-commerce solutions and website maintenance, our team can handle all
                          aspects of your web presence. We pride ourselves on delivering high-quality and
                          user-friendly websites that meet our clients' unique needs. Contact us today to see how we
