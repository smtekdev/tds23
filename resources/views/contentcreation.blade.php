...
<head>
    <meta charset="UTF-8" />
    <title>Content Creation - The Design Spark</title>
     ...
     <li><a href="{{route('graphicdesign')}}">Graphic Design</a></li>
        ...
        <section class="breadcrumb-area breadcrumb-area3 abbn">
            <div class="container video_container">
                <video src="./images/newimg/Content Creation.mp4" autoplay muted loop class="video"></video>
                <div class="row">
                    <div class="col-xl-12">
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center" class="pppd">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal1">
                            <img src="images/newimg/cc1.jpg" class="imgcvr" />
                        </a>
                        <div id="modal1" class="modal mlimg">
                            <img src="images/newimg/cc1.jpg" alt="" class="mlimg1" />
                        </div>
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal2">
                            <img src="images/newimg/cc3.jpg" class="imgcvr" />
                        </a>
                        <div id="modal2" class="modal mlimg">
                            <img src="images/newimg/cc3.jpg" alt="" class="mlimg1" />
                        </div>
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal3">
                            <img src="images/newimg/cc2.jpg" class="imgcvr" />
                        </a>
                        <div id="modal3" class="modal mlimg">
                            <img src="images/newimg/cc2.jpg" alt="" class="mlimg1" />
                        </div>
        ...
        <div class="container-fluid txtbn text-center">
            <div class="row">
                <div class="col-md-12 d-flex align-items-center onhv pad y cta_uper">
                    <div>
                        <h2 class="padbn">
                            Elevate Your Brand with Strategic Content Creation
                        </h2>
                        <p class="padbn">
                            Are you looking to enhance your online presence and engage your
                            audience effectively? Our content creation services focus on
                            producing high-quality, relevant content that resonates with
                            your target market. From blog posts and social media updates to
                            videos and infographics, we develop a comprehensive content
                            strategy tailored to your brand�s unique voice and goals. Let us
                            help you tell your story and connect with your audience through
                            compelling content that drives traffic and builds loyalty.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid pb quote quote_contentcration">
