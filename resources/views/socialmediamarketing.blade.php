...
<head>
    <meta charset="UTF-8" />
    <title>Social Media Marketing - The Design Spark</title>
     ...
     <li><a href="{{route('graphicdesign')}}">Graphic Design</a></li>
      ...
      >
        ...
        <section class="breadcrumb-area breadcrumb-area3 abbn">
            <div class="container">
                <video src="./images/newimg/smm.mp4" autoplay muted loop class="video"></video>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="inner-content text-center clearfix">
                            <div class="big-title" style="color: transparent">
        ...
        <div class="container-fluid txtbn text-center">
            <div class="row">
                <div class="col-md-12 d-flex align-items-center onhv pad y cta_uper">
                    <div>
                        <h2 class="padbn">
                            Amplify Your Brand with Our Social Media Marketing Services
                        </h2>
                        <p class="padbn">
                            In today’s digital landscape, social media isn’t just a platform for sharing cat memes; it’s a powerful marketing tool that can elevate your brand, engage your audience, and drive sales. Our social media marketing services are designed to build a robust online presence, foster community engagement, and transform your followers into loyal customers.
                        </p>
                    </div>
                </div>
            </div>
