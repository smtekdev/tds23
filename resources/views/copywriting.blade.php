...
<head>
    <meta charset="UTF-8" />
    <title>Copywriting - The Design Spark</title>
      ...
      >
        ...
        <section class="breadcrumb-area breadcrumb-area3 abbn">
            <div class="container video_container">
                <video src="./images/newimg/CopyWritting.mp4" autoplay muted loop class="video"></video>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="inner-content text-center clearfix">
                            <div class="big-title" style="color: transparent">
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center" class="pppd">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal1">
                            <img src="images/newimg/cw1.jpg" class="imgcvr" />
                        </a>
                        <div id="modal1" class="modal mlimg">
                            <img src="images/newimg/cw1.jpg" alt="" class="mlimg1" />
                        </div>
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal2">
                            <img src="images/newimg/cw2.jpg" class="imgcvr" />
                        </a>
                        <div id="modal2" class="modal mlimg">
                            <img src="images/newimg/cw2.jpg" alt="" class="mlimg1" />
                        </div>
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal3">
                            <img src="images/newimg/cw3.jpg" class="imgcvr" />
                        </a>
                        <div id="modal3" class="modal mlimg">
                            <img src="images/newimg/cw3.jpg" alt="" class="mlimg1" />
                        </div>
        ...
        <div class="container-fluid txtbn text-center">
            <div class="row">
                <div class="col-md-12 d-flex align-items-center onhv pad y cta_uper">
                    <div>
                        <h2 class="padbn">
                            Engage and Convert with Compelling Copywriting
                        </h2>
                        <p class="padbn">
                            Do you want your brand's message to resonate and drive action?
                            Our professional copywriting services craft persuasive and
                            engaging content that captures your audience's attention.
                            Whether you need website copy, product descriptions, blog posts,
                            or marketing materials, we tailor our writing to reflect your
                            brand's voice and goals. Let us help you communicate effectively
                            and convert visitors into loyal customers with impactful copy
