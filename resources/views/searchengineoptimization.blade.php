...
<head>
    <meta charset="UTF-8" />
    <title>Search Engine Optimization - The Design Spark</title>
     ...
     <li><a href="{{route('graphicdesign')}}">Graphic Design</a></li>
      ...
      >
        ...
        <section class="breadcrumb-area breadcrumb-area3 abbn">
            <div class="container">
                <video src="./images/newimg/seo.mp4" autoplay muted loop class="video"></video>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="inner-content text-center clearfix">
                            <div class="big-title" style="color: transparent">
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center" class="pppd">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal1">
                            <img src="images/newimg/seo1.png" class="imgcvr" />
                        </a>
                        <div id="modal1" class="modal mlimg">
                            <img src="images/newimg/seo1.png" alt="" class="mlimg1" />
                        </div>
                        <!-- <img src="images/newimg/app1.png" alt="Image 2" class="img-fluid imgcvr"> -->
                        <h5>Search Engine Optimization Project 1</h5>
                    </div>
                </div>
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal2">
                            <img src="images/newimg/search3.png" class="imgcvr" />
                        </a>
                        <div id="modal2" class="modal mlimg">
                            <img src="images/newimg/search3.png" alt="" class="mlimg1" />
                        </div>
                        <!-- <img src="images/newimg/app2.png" alt="Image 2" class="img-fluid imgcvr"> -->
                        <h5>Search Engine Optimization Project 2</h5>
                    </div>
                </div>
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal3">
                            <img src="images/newimg/search2.png" class="imgcvr" />
                        </a>
                        <div id="modal3" class="modal mlimg">
                            <img src="images/newimg/search2.png" alt="" class="mlimg1" />
                        </div>
                        <!-- <img src="images/newimg/app3.png" alt="Image 2" class="img-fluid" class="imgcvr"> -->
                        <h5>Search Engine Optimization Project 3</h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12 d-flex align-items-center onhv pad y cta_uper">
                    <div>
                        ...
                        <p class="padbn">
                            In today's digital landscape, having a stunning website is just the beginning. To truly stand out, you need to ensure your target audience can find you. Our comprehensive SEO services are designed to boost your online visibility, drive organic traffic, and enhance your brand's reputation.
