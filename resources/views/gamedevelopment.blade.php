...
<head>
    <meta charset="UTF-8">
    <title>Game Development - The Design Spark</title>
     ...
     <li><a href="{{route('graphicdesign')}}">Graphic Design</a></li>
        ...
        <section class="breadcrumb-area breadcrumb-area3 abbn">
            <div class="container video_container">
                <video src="./images/newimg/Game-Developer.mp4" autoplay muted loop class="video"></video>
                <div class="row">
                    <div class="col-xl-12">
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center" class="pppd">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal1">
                            <img src="images/newimg/game1.webp" class="imgcvr">
                        </a>
                        <div id="modal1" class="modal mlimg"><img src="images/newimg/game1.webp" alt="" class="mlimg1">
                        </div>
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center">
                        <a href="#" class="image-modal img-fluid " data-modal-id="modal2">
                            <img src="images/newimg/game5.jpg" class="imgcvr">
                        </a>
                        <div id="modal2" class="modal mlimg"><img src="images/newimg/game5.jpg" alt="" class="mlimg1">
                        </div>
                ...
                <div class="col-md-4 brrd rainbow">
                    <div class="text-center">
                        <a href="#" class="image-modal img-fluid" data-modal-id="modal3">
                            <img src="images/newimg/game3.jpg" class="imgcvr">
                        </a>
                        <div id="modal3" class="modal mlimg"><img src="images/newimg/game3.jpg" alt="" class="mlimg1">
                        </div>
        ...
        <div class="container-fluid txtbn text-center">
            <div class="row">
                <div class="col-md-12 d-flex align-items-center onhv pad y cta_uper ">
                    <div>
                        <h2 class=" padbn"> Bring Your Ideas to Life with Innovative Game Development</h2>
                        <p class="padbn">Ready to create a captivating gaming experience? Our game development team
                            specializes in designing and building engaging games across various platforms. From concept
                            to launch, we utilize the latest technologies and creative storytelling to develop immersive
                            gameplay that captivates players. Whether you need a mobile game, desktop application, or
                            virtual reality experience, we tailor our development process to meet your specific needs.
                            Let us transform your vision into a reality and deliver a game that stands out in the
                            competitive gaming market.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid pb quote quote_game_development">
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6" style="margin-top: -8%;">
                    <div class="card border-0 bg-transparent">
                        <div class="card-body text-center">
                            <h2 class="text-light mb-4 mtpo"
                                style="color: white !important; text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000;">
                                Get a Quote</h2>
                            <form>
                                ...
                                <a href="contactform.html">
                                    <button type="submit" class="btn btn-primary custom-btn"
                                        style="background-color: #A30529; border: none; border-radius: 50px; padding: 2%; width: 10rem;padding-bottom: 1rem;">Submit
                                        Request</button>
                                </a>
                            </form>
                        </div>
