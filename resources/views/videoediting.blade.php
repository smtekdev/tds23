...
<head>
    <meta charset="UTF-8" />
    <title>Video Editing - The Design Spark</title>
     ...
     <li><a href="{{route('graphicdesign')}}">Graphic Design</a></li>
      ...
      >
        ...
        <section class="breadcrumb-area breadcrumb-area3 abbn">
            <div class="container">
                <video src="./images/newimg/Video Editing.mp4" autoplay muted loop class="video"></video>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="inner-content text-center clearfix">
                            <div class="big-title" style="color: transparent">
            ...
            <div class="row">
                <div class="col-md-12 d-flex align-items-center onhv pad y cta_uper">
                    <div>
                        ...
                        <p class="padbn">
                            Looking for captivating videos that grab attention and tell your story? Our talented video editing team specializes in creating eye-catching edits tailored to your brand. From dynamic promotional videos to engaging storytelling, we bring your ideas to life with creativity and precision. Let us help you enhance your brand's narrative and connect with your audience through the power of video editing.
                        </p>
                    </div>
                </div>
            </div>
