...
<head>
    <meta charset="UTF-8" />
    <title>Website Design - The Design Spark</title>
  ...
  <ul id="menu" style="margin-left: -45%;">
    ...
    <li><a href="{{route('websitedevelopment')}}">Web Development</a></li>
     <li><a href="{{route('graphicdesign')}}">Graphic Design</a></li>
        ...
        <!-- <section
        class="breadcrumb-area breadcrumb-area3 abbn"
        style="
          background: url('images/newimg/webdesignbanimate.gif');
      ...
      >
        ...
        <section class="breadcrumb-area breadcrumb-area3 abbn">
            <div class="container">
                <video src="./images/newimg/webd.mp4" autoplay muted loop class="video"></video>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="inner-content text-center clearfix">
                            <div class="big-title" style="color: transparent">
        ...
        <div class="container-fluid txtbn text-center">
            <div class="row">
                <div class="col-md-12 d-flex align-items-center onhv pad y cta_uper">
                    <div>
                        <h2 class="padbn">
                            Transform Your Vision into Stunning Animations
                        </h2>
                        <p class="padbn">
                            Looking for captivating animations that grab attention and tell
                            your story? Our talented animation team specializes in creating
                            eye-catching 2D and 3D animations tailored to your brand. From
                            dynamic explainer videos to engaging character animations, we
                            bring your ideas to life with creativity and precision. Let us
                            help you enhance your brand's narrative and connect with your
                            audience through the power of animation.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid pb quote">
