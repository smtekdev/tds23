...
<head>
    <meta charset="UTF-8" />
    <title>2D & 3D Animations - The Design Spark</title>
    ...
    <div class="boxed_wrapper">
      ...
      >
        ...
        <section class="breadcrumb-area breadcrumb-area3 abbn">
            <div class="container">
                <video src="./images/newimg/Animation.mp4" autoplay muted loop class="video"></video>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="inner-content text-center clearfix">
                            <div class="big-title" style="color: transparent">
